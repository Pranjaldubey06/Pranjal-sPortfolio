...
//               <FaLinkedin
//                 size={28}
//                 href="https://www.linkedin.com/in/pranjal-dubey-b26b3a240/"
...
//               <FaGithub
//                 size={28}
//                 href="https://github.com/Pranjaldubey06"
        ...
        >
          ...
          >
            ...
            >
              <FaLinkedin
                size={28}
                className="text-white hover:text-[#0077B5] transition transform hover:scale-110"
              />
            </a>
            ...
            >
              <FaInstagram
                size={28}
                className="text-white hover:text-[#E1306C] transition transform hover:scale-110"
              />
            </a>
          </motion.div>
          ...
          <motion.a
            ...
            transition={{ duration: 0.8, delay: 1.3 }}
          >
            <button className="bg-purple-800 hover:bg-purple-700 cursor-pointer transition text-white px-6 py-2 rounded-full text-base sm:text-lg font-medium">
              Download CV
            </button>
          </motion.a>
        </motion.section>

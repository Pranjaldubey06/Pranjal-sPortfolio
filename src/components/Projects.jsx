    ...
    <article className="relative bg-gray-800 rounded overflow-hidden shadow-lg group flex flex-col items-center justify-between mx-auto w-full h-full ">
      ...
      <div className="relative z-10 w-full flex flex-col h-full">
        ...
        <div className="flex-grow px-4 py-4 flex flex-col justify-between">
          <h3 className="text-white font-bold text-lg sm:text-xl mb-2 text-center">
            {title}
          </h3>
...
export default function Projects() {
  const listProjects = [
    ...
    },
    {
      ...
      link: "https://my-netflix-movie-app.vercel.app/"
    },
    {
      image:
        "https://multichannelmerchant.com/wp-content/uploads/2019/05/amazonsouq850.jpg",
  ...
  return (
    <main className="p-4 mt-24">
      ...
      <section className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mt-6 cursor-pointer">
